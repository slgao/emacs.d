...
** orgmode beamer
   #+BEGIN_SRC emacs-lisp
       ;; deferred: requiring ox-latex here loads the whole org export
       ;; stack (~2s) at startup; register the class when the latex
       ;; exporter actually loads instead
...
** org latex classes.
   ...
   to use this #+LaTeX_CLASS: bjmarticle
** provide package
   #+BEGIN_SRC emacs-lisp
     (provide 'init-utils)
   #+END_SRC
